...
.calc_time_outer:
    ...
    mov [g_currentGuardSleepData.mins_asleep_best], 0
    mov [g_currentGuardSleepData.minute_best], 0
...
@@: add [g_minuteAccumArray + r15d * 4], 1
    add r15d, 1
    cmp r15d, r11d
    jnz @r
...
@@: cmp eax, dword [g_minuteAccumArray + r15 * 4]
    ...
    ; check if this dude beats the other guards time
    cmp eax, [g_bestGuardSleepData.mins_asleep_best]
    jbe .calc_time_outer_loop_next

    mov [g_bestGuardSleepData.mins_asleep_best], eax
    mov r15d, [g_currentGuardSleepData.guard_id]
    mov [g_bestGuardSleepData.guard_id], r15d
    mov [g_bestGuardSleepData.minute_best], r14d
...
.end:
    ...
    mov eax, [g_bestGuardSleepData.minute_best]
